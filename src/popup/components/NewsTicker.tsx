      ...
      <div className="relative">
        ...
        {news.length > 1 && (
          <>
            <button
              onClick={goPrev}
              className="absolute left-1 top-1/2 -translate-y-1/2 z-10 w-6 h-6 rounded-full bg-gray-800/80 hover:bg-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-all opacity-0 group-hover:opacity-100 hover:opacity-100"
            ...
            <button
              onClick={goNext}
              className="absolute right-1 top-1/2 -translate-y-1/2 z-10 w-6 h-6 rounded-full bg-gray-800/80 hover:bg-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-all"
              style={{ opacity: isHovered ? 1 : 0 }}
            >
              ›
            </button>
